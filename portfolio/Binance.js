...
function BinMenu(ui) {
  ...
  ui.createMenu('Special functions')
    .addItem('Average stock price', 'avgStockPrice')
    .addItem('Crypto coin count', 'cryptoCoinsCount')
    .addItem('Total net worth', 'totalValueHistoryFromButton')
    .addSeparator()
    .addItem('Freeze selected cells to values', 'freezeSelectedCellsToValues')
    .addItem('Freeze portfolio block to values', 'freezeBlockToValues')
    .addToUi();
